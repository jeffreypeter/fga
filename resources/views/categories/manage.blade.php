		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<a href="{{ URL::to('categories/create') }}" class="btn btn-primary">Add Category</a>
						<div class="shell">
							<table id="manage-categories" class="display responsive" width="100%">
								<thead>
								<tr>
									{{--<th>Id</th>--}}
									<th>Name</th>
								...
								@foreach($categories as $key => $value)
									<tr>
										<td><a href="{{ URL::to('categories/' . $value->id. '/edit') }}">{{ $value->name }}</a></td>
										<td>{{ $value->description }}</td>
										<td>
											<div class="btn-group actions" role="group" aria-label="actions">
												<button onclick="window.location.href='{{ URL::to('categories/' . $value->id. '/edit') }}'" class="btn btn-info btn-secondary"><i class="fa fa-edit" aria-hidden="true"></i></button>
...
@section('myscript')
	...
	<script src="{{ asset('js/views/categories/manage.js') }}"></script>
@endsection